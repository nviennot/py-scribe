...
SCRIBE_PS_MUTATING            = scribe_api.SCRIBE_PS_MUTATING
...
SCRIBE_PS_RET_CHECK           = scribe_api.SCRIBE_PS_RET_CHECK
SCRIBE_PS_STRICT_REPLAY       = scribe_api.SCRIBE_PS_STRICT_REPLAY
SCRIBE_PS_FIXED_IO            = scribe_api.SCRIBE_PS_FIXED_IO
...
SCRIBE_PERMANANT             = scribe_api.SCRIBE_PERMANANT
SCRIBE_UNTIL_NEXT_SYSCALL    = scribe_api.SCRIBE_UNTIL_NEXT_SYSCALL
